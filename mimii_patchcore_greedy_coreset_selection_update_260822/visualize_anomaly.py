...
def aggregate_features(
    ...
    train.py / test.py의 patchcore.aggregate_features()와 동일하게,
    §3.1의 locally aware patch feature(p x p 이웃 average pooling)를
    먼저 적용한 뒤 layer3를 layer2 해상도로 리사이즈해서 합친다.
